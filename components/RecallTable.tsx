...
export function RecallTable() {
    ...
    return (
        <div className="w-full max-w-6xl mx-auto overflow-hidden rounded-3xl border border-slate-800 bg-slate-900 shadow-[0_20px_50_rgba(0,0,0,0.5)] animate-in fade-in slide-in-from-bottom-8 duration-700">
